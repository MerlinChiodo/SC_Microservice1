...
import { TextInput, Button, Select, NumberInput, Grid } from '@mantine/core';
...
export const Register = () => {
  ...
  return (
    <PageContainer title="In der SmartCity melden">
      <form onSubmit={form.onSubmit(handleSubmit)}>
        <Grid grow gutter="xl" align="center">
          ...
          <Grid.Col md={12}>
            <Button fullWidth mt="lg" type="submit">Jetzt melden</Button>
          </Grid.Col>
        </Grid>
      </form>
    </PageContainer>
